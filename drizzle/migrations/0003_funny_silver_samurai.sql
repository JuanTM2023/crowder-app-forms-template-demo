ALTER TABLE "food_vouchers" RENAME COLUMN "show" TO "show_name";--> statement-breakpoint
...
ALTER TABLE "transactions" ADD COLUMN "show_id" text;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "items_snapshot" jsonb;--> statement-breakpoint
