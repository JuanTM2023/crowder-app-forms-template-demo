...
--> statement-breakpoint
ALTER TABLE "forms" ADD COLUMN "producer_id" uuid;--> statement-breakpoint
ALTER TABLE "products" ADD COLUMN "service_fee" double precision DEFAULT 0 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "food_vouchers" ADD CONSTRAINT "food_vouchers_transaction_id_transactions_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."transactions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "forms" ADD CONSTRAINT "forms_producer_id_producers_id_fk" FOREIGN KEY ("producer_id") REFERENCES "public"."producers"("id") ON DELETE no action ON UPDATE no action;